...
from Tkinter import Tk, LEFT, RIGHT, BOTH, RAISED, OptionMenu, StringVar, Listbox, Menubutton, END, MULTIPLE
...
def main(master=None, parent_console=None, character_database=None):
    ...
    root = Tk()
    app = CharacterImporter(master, parent_console, character_database)
    root.mainloop()
