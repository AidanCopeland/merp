...
class AwarenessSensesManeuverTable(StaticManeuverTable):
    ...
    def select_awareness_senses_table(maneuver_type):
        ...
        from Maneuvers.AwarenessSenses.DirectionSenseManeuverTable import DirectionSenseManeuverTable
        from Maneuvers.AwarenessSenses.SLAManeuverTable import SLAManeuverTable
        from Maneuvers.AwarenessSenses.TimeSenseManeuverTable import TimeSenseManeuverTable
