...
class WeightLiftingManeuverTable(AthleticBrawnManeuverTable):
    ...
    def setup_maneuver_skill_frames(self, parent_frame):
        ...
        def setup_flat_surface_frame():
            ...
            """
            trace.entry()
            FrameUtils.setup_checkbox_frame(parent_frame, FLAT_SURFACE_TEXT, self.flat_surface)
            trace.exit()
        ...
        def setup_uneven_frame():
            ...
            """
            trace.entry()
            FrameUtils.setup_checkbox_frame(parent_frame, UNEVEN_TEXT, self.uneven)
            trace.exit()
        ...
        def setup_hand_holds_frame():
            ...
            """
            trace.entry()
            FrameUtils.setup_checkbox_frame(parent_frame, HAND_HOLDS_TEXT, self.hand_holds)
            trace.exit()
        ...
        def setup_extra_prep_frame():
            ...
            """
            trace.entry()
            FrameUtils.setup_checkbox_frame(parent_frame, EXTRA_PREP_TEXT, self.extra_prep)
            trace.exit()
