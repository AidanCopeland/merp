...
Functions:
    find_table_row_index(table_minimum_values, roll)
    find_merp_table_row_entry(table, roll)
"""
import sys
...
merp_table_minimum_values = [
    0, 6, 21, 36, 51, 66, 80, 81, 87, 90, 91, 97, 100, 101, 107, 110, 111, 117, 120]
