...
class NameSelector(Frame):
    ...
    def init_ui(self):
        ...
        def add_entries_to_race_selector():
            trace.entry()
        ...
        init_ui_title()
        init_ui_race_selector()
        init_ui_db_size_display()
        init_ui_gender_selector()
        init_ui_num_names_input()
        init_ui_go_button()
        init_ui_output_display()

        add_entries_to_race_selector()
