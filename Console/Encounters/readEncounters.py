...
class EncounterData(object):
    ...
    def __read_encounter_type(self, line):
        read_encounter_type = line.pop(0)
        self.encounters.append(read_encounter_type)
...
print("Encounter happened? %r. "
      "Distance was %d miles, time was %d hours, encounter was with %s" %
      (encounter_happened, encounter_distance, encounter_time, encounter_type))
