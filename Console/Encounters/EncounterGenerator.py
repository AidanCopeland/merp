...
from tkinter.ttk import Frame, Style, Label, Entry, Button, Scrollbar
...
class EncounterGenerator(Frame):
    ...
    def init_ui(self, base_directory):
        ...
        init_ui_module_area()
        init_ui_interval()
        init_ui_encounter_number()
        init_ui_trigger_button()
        init_ui_encounter_details()

        initialize_regions()
        initialize_modules_areas()
