...
sys.path.append('./Character database')#
sys.path.append('./Dice roller')#
sys.path.append('./Encounters/')#
sys.path.append('./Encounters/Modules')#
sys.path.append('./Maneuvers')#
sys.path.append('./Name database')#

import trace_log as trace

from Tkinter import Tk, LEFT, RIGHT, END, BOTH, TOP, RAISED, W, Y, StringVar, OptionMenu, Text, _setit, Toplevel
from ttk import Frame, Style, Label, Button
from tk_helper import clear_option_menu, refresh_option_menu
from CharacterManager import CharacterManager
from CharacterDatabase import CharacterDatabase
from DiceRoller import DiceRoller
from EncounterGenerator import EncounterGenerator
from ManeuverTable import ManeuverTable
...
class Console(Frame):
    ...
    def initUI(self):
        ...
        def add_entries_to_option_selector(self):
            trace.entry()
