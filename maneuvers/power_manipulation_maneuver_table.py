...
from console.character.magical_skills import SKILL_CHANNELING, SKILL_DIRECTED_SPELLS, SKILL_MAGIC_RITUAL, SKILL_MENTAL_CONTROL, SKILL_SPELL_ARTISTRY, SKILL_SPELL_MASTERY, SKILL_SPELL_TRICKERY, SKILL_SUMMONING
