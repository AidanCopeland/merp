# -*- coding: utf-8 -*-
"""
The base moving maneuver table.
...
class MovingManeuverTable():
    ...
    def get_result_row(self, dice_result):
        ...
        # Subtract 1 then divide the result by 5 (using integer division) to reduce the number of
        # results to handle.
    ...
    def setup_maneuver_table_frames(self, parent_frame):
        ...
        def setup_limb_out_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_checkbox_frame(parent_frame, LIMB_OUT_TEXT, self.limb_out)
            trace.exit()
        ...
        def setup_down_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_checkbox_frame(parent_frame, DOWN_TEXT, self.down)
            trace.exit()
