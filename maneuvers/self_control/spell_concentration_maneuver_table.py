# -*- coding: utf-8 -*-
"""
The Spell Concentration static maneuver table.
...
class SpellConcentrationManeuverTable(SelfControlManeuverTable):
    """
    Spell Concentration static maneuver table.
    ...
    Methods:
        ...
        activity_bonus(self)
        trance_bonus(self)
        surroundings_bonus(self)
        interruptions_bonus(self)
        startled_bonus(self)
        physical_strike_bonus(self)
    """
    ...
    def setup_maneuver_skill_frames(self, parent_frame):
        ...
        def setup_activity_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, ACTIVITY_TEXT, self.additional_activity)
            trace.exit()
        ...
        def setup_meditative_trance_frame():
            ...
            frame_utils.setup_checkbox_frame(parent_frame,
                                             MEDITATIVE_TRANCE_TEXT,
                                             self.meditative_trance)
            trace.exit()
        ...
        def setup_surroundings_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, SURROUNDINGS_TEXT, self.surroundings)
            trace.exit()
        ...
        def setup_interruptions_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, INTERRUPTION_TEXT, self.num_interruptions)
            trace.exit()
        ...
        def setup_startled_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_checkbox_frame(parent_frame, STARTLED_TEXT, self.startled)
            trace.exit()
