# -*- coding: utf-8 -*-
"""
The Lie Perception static maneuver table.
...
class LiePerceptionManeuverTable(AwarenessSearchingManeuverTable):
    """
    Lie Perception static maneuver table.
    ...
    def setup_maneuver_skill_frames(self, parent_frame):
        ...
        def setup_cannot_see_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_checkbox_frame(parent_frame, CANNOT_SEE_TEXT, self.cannot_see)
            trace.exit()
        ...
        def setup_cannot_hear_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_checkbox_frame(parent_frame, CANNOT_HEAR_TEXT, self.cannot_hear)
            trace.exit()
        ...
        def setup_language_ranks_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, LANGUAGE_RANKS_TEXT, self.language_ranks)
            trace.exit()
