# -*- coding: utf-8 -*-
"""
The Psychology static maneuver table.

Classes:
    PsychologyManeuverTable

Functions:
    illness_level_bonus(illness_level)
    years_affected_bonus(years_affected)
"""
import sys
...
class PsychologyManeuverTable(ScienceAnalyticManeuverTable):
    """
    Psychology static maneuver table.
    ...
    def setup_maneuver_skill_frames(self, parent_frame):
        ...
        def setup_years_affected_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, YEARS_TEXT, self.years_affected)
            trace.exit()
        ...
        def setup_event_severity_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, SEVERITY_TEXT, self.event_severity)
            trace.exit()
        ...
        def setup_npc_level_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, LEVEL_TEXT, self.npc_level)
            trace.exit()
