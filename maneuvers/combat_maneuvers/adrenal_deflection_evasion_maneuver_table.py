...
class AdrenalDeflectionEvasionManeuverTable(MovingManeuverTable):
    """
    Adrenal Deflection or Evasion moving maneuver table.
    ...
    def setup_difficulty_frame(self, parent_frame):
        ...
        self.maneuver_difficulty_options = self.get_weapon_options()
    ...
    def difficulty_table_column(self):
        ...
        """
        difficulty = self.get_weapon_difficulty()
        return maneuver_difficulty_table_columns[difficulty]

    @staticmethod
    def get_weapon_difficulty():
        """
