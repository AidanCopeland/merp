# -*- coding: utf-8 -*-
"""
The Magic Ritual static maneuver table.

Classes:
    MagicRitualManeuverTable

Functions:
    caster_type_bonus(caster_type)
"""
import sys
...
class MagicRitualManeuverTable(PowerManipulationManeuverTable):
    """
    Magic Ritual static maneuver table.
    ...
    def setup_maneuver_skill_frames(self, parent_frame):
        ...
        def setup_gm_bonus_frame():
            ...
            """
            trace.entry()
            frame_utils.setup_entry_frame(parent_frame, TAKING_TIME_TEXT, self.gm_bonus)
            trace.exit()
