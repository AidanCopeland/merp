...
class WeatherTable(object):
    def __init__(self, filename, full_open, standard_tables):
        ...
        :param full_open: Whether to load all information from the weather table, or just the module.
    ...
    def __load_module_name(self, weather_file):
        ...
        """
        trace.entry()
        readData.move_past_keyword(weather_file, "Module")
        self.module = readData.read_tabbed_line(weather_file)[0]
    ...
    def __load_regions(self, weather_file):
        ...
        """
        trace.entry()
        readData.move_past_keyword(weather_file, "Regions")
        self.regions_list = readData.read_tabbed_line(weather_file)
    ...
    def __load_weather_parameters(self, weather_file):
        ...
        """
        trace.entry()
        readData.move_past_keyword(weather_file, "Weather")
        self.__init_weather_lists()
        line = readData.read_tabbed_line(weather_file)
    ...
    def __load_weather_extras(self, weather_file):
        ...
        """
        trace.entry()
        readData.move_past_keyword(weather_file, "Extras")
    ...
    def __read_month(self, text_line):
        """
    ...
    def __load_month_region_values(self, text_line):
        ...
        for region_index in range(0, self.regions_count):
            ...
            per_region_values = readData.read_semicolon_text(weather_info)
    ...
    def get_average_min_temperature(self, region_name, month_name):
        """
        Returns the average minimum temperature for the specified region 
        and month.
        ...
        trace.detail("Min temp %d" % min_temp)
        trace.exit()
        return min_temp
    ...
    def get_average_max_temperature(self, region_name, month_name):
        ...
        trace.detail("Max temp %d" % max_temp)
        trace.exit()
        return max_temp
    ...
    def get_rain_chance(self, region_name, month_name):
        ...
        trace.detail("Rain chance %d" % rain_chance)
        trace.exit()
        return rain_chance
