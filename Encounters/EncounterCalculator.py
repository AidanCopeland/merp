    ...
    def __get_encounters(self):
        ...
        for i in range(0, self.num_encounters, 1):
            ...
            if self.current_module == "Lake Town (rural)":
                ...
                category_roll = 0
                if self.encounter_table.categories_present == True:
            ...
            if encounter_happened:
                ...
                encounter_extras = self.encounter_table.get_encounter_extras(encounter_type, self.current_area, extras_roll)
