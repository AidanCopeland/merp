...
from Tkinter import Tk, LEFT, RIGHT, END, BOTH, RAISED, StringVar, Text, Toplevel, _setit
from ttk import Frame, Style, Label, Entry, Button, OptionMenu
...
class DiceRoller(Frame):
    ...
    def __init__(self, master, parent_console):
        ...
        def display_dice_value_choice(self):
            trace.entry()
        ...
        def display_num_dice_choice(self):
            trace.entry()
        ...
        def display_combine_dice_choice(self):
            trace.entry()
        ...
        display_title(self)
        display_dice_value_choice(self)
        display_num_dice_choice(self)
        display_combine_dice_choice(self)
        display_roll_dice(self)
        display_roll_results(self)

        refresh_option_menus(self)
    ...
    def dice_value_change_callback(self, *args):
        trace.entry()
    ...
    def num_dice_change_callback(self, *args):
        trace.entry()
    ...
    def combine_dice_change_callback(self, *args):
        trace.entry()
...
def main(master = None, parent_console = None):
    ...
    root = Tk()
    app = DiceRoller(master, parent_console)
    root.mainloop()
