        ...
        self.name_database = {
            ...
            [
                ["Aldan", "Aldor", "Angrod", "Atilik", "Azaghal", "Báin", "Bair", "Baldur", "Balin",
                 "Balli", "Balrim", "Barin", "Bávor", "Bohór", "Bowlin", "Bróin", "Brór", "Burin",
                 "Bwalin", "Cori", "Craier", "Dain", "Dáin", "Dár", "Dáram", "Darim", "Darin",
                 "Darzum", "Dhebun", "Dhemim", "Dheo", "Dibin", "Dintam", "Dirn", "Dolin", "Dóm",
                 "Dór", "Dori", "Dralin", "Drarin", "Drúhar", "Drúin", "Drús", "Duildin", "Durzil",
                 "Dwáin", "Dwalin", "Falin", "Farin", "Flói", "Fóli", "Fori", "Forin", "Frár",
                 "Freri", "Frerin", "Fror", "Frór", "Frúhar", "Frúin", "Fulla", "Fundin", "Gáin",
                 "Ghamim", "Ghar", "Gimbal", "Gimithor", "Gimlin", "Glein", "Gloin", "Glorin",
                 "Grális", "Gróin", "Grolin", "Gror", "Gulla", "Gura", "Gurh", "Gurim", "Gurin",
                 "Gurn", "Halin", "Ibír", "Ibûn", "Kaidin", "Kalin", "Kallin", "Khadak", "Khain",
                 "Khanil", "Khanli", "Khîm", "Khorni", "Kíli", "Kóri", "Kuri", "Líli", "Lóni",
                 "Miffli", "Miffli", "Mîm", "Moranar", "Nain", "Náin", "Nali", "Náli", "Nár",
                 "Naric", "Narmire", "Naug", "Nedilli", "Nori", "Nurís", "Obun", "Ohtar", "Oin",
                 "Óin", "Omim", "Ori", "Orn", "Purfin", "Rálin", "Rhomin", "Rhotti", "Rúrin",
                 "Seldur", "Tali", "Thalin", "Tharangul", "Thelór", "Thíst", "Thorin", "Thráin",
                 "Thrangull", "Thrár", "Threlin", "Thrír", "Throdin", "Thror", "Thrórin", "Thrúr",
                 "Thúlin", "Thurin", "Tili", "Tíli", "Zafor", "Zdori", "Zeddic", "Zorn", "Zrór"],
