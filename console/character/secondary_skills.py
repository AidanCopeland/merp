...
SKILL_RELIGION_LORE = "Religion Lore"
JSON_RELIGION_LORE = "religion-lore"
...
json_input_map = {
    ...
    JSON_RELIGION_LORE: SKILL_RELIGION_LORE,
    ...
    JSON_TRADING_LORE: JSON_TRADING_LORE,
